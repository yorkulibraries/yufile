...
\committeenote{The {\tt committeenote} command can be used to add a note from the File Preparation Committee, briefly explaining something, for example that most of the work of the committee is confidential in nature.  Committee notes are in italics.}

\candidatenote{A candidate's note can go on the same page.}
